...
- [ ] Identify and decode Battlespire texture containers (likely BSI/CIF-related paths hinted by `TEXI/DIRN`).
- [ ] Map 3D face texture tags to concrete texture resources.
